...
# Form implementation generated from reading ui file 'CSQueuingSystem_Admin.ui'
#
...
class Ui_ccsqueue_admin(object):
    def setupUi(self, ccsqueue_admin):
        ccsqueue_admin.setObjectName("ccsqueue_admin")
        ccsqueue_admin.resize(1000, 610)
        ccsqueue_admin.setMinimumSize(QtCore.QSize(1000, 610))
        ccsqueue_admin.setStyleSheet("background-color: rgb(0, 58, 108);")
        self.centralwidget = QtWidgets.QWidget(ccsqueue_admin)
...
"color: rgb(0, 58, 108);")
        ...
        ccsqueue_admin.setCentralWidget(self.centralwidget)

        self.retranslateUi(ccsqueue_admin)
        self.stackedWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(ccsqueue_admin)

    def retranslateUi(self, ccsqueue_admin):
        _translate = QtCore.QCoreApplication.translate
        ccsqueue_admin.setWindowTitle(_translate("ccsqueue_admin", "MainWindow"))
        self.label_5.setText(_translate("ccsqueue_admin", "Computer Studies Queuing System"))
        self.minimize_btn.setToolTip(_translate("ccsqueue_admin", "Minimize"))
        self.maximize_btn.setToolTip(_translate("ccsqueue_admin", "Maximize"))
        self.close_btn.setToolTip(_translate("ccsqueue_admin", "Close"))
        self.queue_button.setText(_translate("ccsqueue_admin", "QUEUE"))
        self.roomreservation_button.setText(_translate("ccsqueue_admin", "ROOM RESERVATION"))
        self.appointment_button.setText(_translate("ccsqueue_admin", "APPOINTMENT SETTER"))
        self.scholarquests_button.setText(_translate("ccsqueue_admin", "SCHOLAR QUESTS"))
        self.account_button.setText(_translate("ccsqueue_admin", "ACCOUNT"))
        self.settings_button.setText(_translate("ccsqueue_admin", "SETTINGS"))
        self.label_3.setText(_translate("ccsqueue_admin", "Queue"))
        self.currentnum_display.setText(_translate("ccsqueue_admin", "0"))
        self.label_4.setText(_translate("ccsqueue_admin", "NOW SERVING"))
        self.nextinline_slot1.setText(_translate("ccsqueue_admin", "0"))
        self.nextinline_slot2.setText(_translate("ccsqueue_admin", "0"))
        self.nextinline_slot3.setText(_translate("ccsqueue_admin", "0"))
        self.label_10.setText(_translate("ccsqueue_admin", "NEXT IN LINE"))
        self.label.setText(_translate("ccsqueue_admin", "        GET QUEUE NUMBER"))
        self.label_2.setText(_translate("ccsqueue_admin", "           SELECT PURPOSE HERE:"))
        self.enrollmentqueue_btn.setText(_translate("ccsqueue_admin", "Enrollment"))
        self.clearancequeue_btn.setText(_translate("ccsqueue_admin", "Clearance"))
        self.academicsqueue_btn.setText(_translate("ccsqueue_admin", "Academics"))
        self.organizationqueue_btn.setText(_translate("ccsqueue_admin", "Organization"))
        self.regularlane_btn.setText(_translate("ccsqueue_admin", "Regular Lane"))
        self.facultylane_btn.setText(_translate("ccsqueue_admin", "Faculty Lane"))
        item = self.queue_table.horizontalHeaderItem(0)
        item.setText(_translate("ccsqueue_admin", "Date and Time"))
        item = self.queue_table.horizontalHeaderItem(1)
        item.setText(_translate("ccsqueue_admin", "Room"))
        item = self.queue_table.horizontalHeaderItem(2)
        item.setText(_translate("ccsqueue_admin", "State"))
        item = self.queue_table.horizontalHeaderItem(3)
        item.setText(_translate("ccsqueue_admin", "Reason"))
        self.acceptQueue_btn.setText(_translate("ccsqueue_admin", "Accept"))
        ...
        item.setText(_translate("ccsqueue_admin", "Reason"))
        self.tp_setRsv_btn.setText(_translate("ccsqueue_admin", "Set"))
        item = self.pendingRsv_table.horizontalHeaderItem(0)
        item.setText(_translate("ccsqueue_admin", "Date of Request"))
        item = self.pendingRsv_table.horizontalHeaderItem(1)
        item.setText(_translate("ccsqueue_admin", "Date and Time"))
        item = self.pendingRsv_table.horizontalHeaderItem(2)
        item.setText(_translate("ccsqueue_admin", "Name"))
        item = self.pendingRsv_table.horizontalHeaderItem(3)
        item.setText(_translate("ccsqueue_admin", "Room"))
        item = self.pendingRsv_table.horizontalHeaderItem(4)
        item.setText(_translate("ccsqueue_admin", "Reason"))
        self.acceptRsv_btn.setText(_translate("ccsqueue_admin", "Accept"))
        self.declineRsv_btn.setText(_translate("ccsqueue_admin", "Decline"))
        self.backRsv_btn.setText(_translate("ccsqueue_admin", "Back"))
        self.label_17.setText(_translate("ccsqueue_admin", "Date and Time"))
        self.label_18.setText(_translate("ccsqueue_admin", "Room"))
        self.label_19.setText(_translate("ccsqueue_admin", "Reason"))
        self.roomRsv.setCurrentText(_translate("ccsqueue_admin", "FH 101"))
        self.roomRsv.setItemText(0, _translate("ccsqueue_admin", "FH 101"))
        self.confirmRsv.setText(_translate("ccsqueue_admin", "Confirm your choices"))
        self.setRsv_btn.setText(_translate("ccsqueue_admin", "Set"))
        self.cancelRsv_btn.setText(_translate("ccsqueue_admin", "Cancel"))
        __sortingEnabled = self.listApt.isSortingEnabled()
        self.listApt.setSortingEnabled(False)
        item = self.listApt.item(0)
        item.setText(_translate("ccsqueue_admin", "d"))
        item = self.listApt.item(1)
        item.setText(_translate("ccsqueue_admin", "d"))
        item = self.listApt.item(2)
        item.setText(_translate("ccsqueue_admin", "d"))
        self.listApt.setSortingEnabled(__sortingEnabled)
        self.tp_chkApt_btn.setText(_translate("ccsqueue_admin", "Check Pending"))
        self.tp_setApt_btn.setText(_translate("ccsqueue_admin", "Set"))
        ...
        item.setText(_translate("ccsqueue_admin", "Reason"))
        self.acceptApt_btn.setText(_translate("ccsqueue_admin", "Accept"))
        self.declineApt_btn.setText(_translate("ccsqueue_admin", "Decline"))
        self.backApt_btn.setText(_translate("ccsqueue_admin", "Back"))
        item = self.quest_table.horizontalHeaderItem(0)
        item.setText(_translate("ccsqueue_admin", "Title"))
        item = self.quest_table.horizontalHeaderItem(1)
        item.setText(_translate("ccsqueue_admin", "Date and Time"))
        item = self.quest_table.horizontalHeaderItem(2)
        item.setText(_translate("ccsqueue_admin", "Duration"))
        item = self.quest_table.horizontalHeaderItem(3)
        item.setText(_translate("ccsqueue_admin", "Points"))
        item = self.quest_table.horizontalHeaderItem(4)
        item.setText(_translate("ccsqueue_admin", "Description"))
        self.tp_acceptQuest_btn.setText(_translate("ccsqueue_admin", "Accept a Quest"))
        ...
        item.setText(_translate("ccsqueue_admin", "Description"))
        self.acceptQuest_btn.setText(_translate("ccsqueue_admin", "Accept"))
        self.label_13.setText(_translate("ccsqueue_admin", "  Account Details"))
        self.label_14.setText(_translate("ccsqueue_admin", "NAME"))
        self.label_15.setText(_translate("ccsqueue_admin", "COURSE"))
        self.label_16.setText(_translate("ccsqueue_admin", "ID NUMBER"))
        self.label_20.setText(_translate("ccsqueue_admin", "SCHOOL EMAIL"))
        self.label_21.setText(_translate("ccsqueue_admin", "Name here"))
        self.label_22.setText(_translate("ccsqueue_admin", "Course here"))
        self.label_23.setText(_translate("ccsqueue_admin", "ID Number here"))
        self.label_24.setText(_translate("ccsqueue_admin", "School Email here"))
        self.label_12.setText(_translate("ccsqueue_admin", "Settings"))
import resource_rc
...
if __name__ == "__main__":
    ...
    ccsqueue_admin = QtWidgets.QMainWindow()
    ui = Ui_ccsqueue_admin()
    ui.setupUi(ccsqueue_admin)
    ccsqueue_admin.show()
    sys.exit(app.exec_())
