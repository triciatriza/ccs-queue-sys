...
"}")
        ...
        self.gridLayout_9 = QtWidgets.QGridLayout(self.setquests_page)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.frame_52 = QtWidgets.QFrame(self.setquests_page)
        ...
        self.availableQuest_table = QtWidgets.QTableWidget(self.setquests_page)
        ...
        self.setQuest_btn = QtWidgets.QPushButton(self.frame_51)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.setQuest_btn.sizePolicy().hasHeightForWidth())
        self.setQuest_btn.setSizePolicy(sizePolicy)
        self.setQuest_btn.setAutoDefault(False)
        self.setQuest_btn.setDefault(False)
        self.setQuest_btn.setFlat(False)
        self.setQuest_btn.setObjectName("setQuest_btn")
        self.gridLayout_10.addWidget(self.setQuest_btn, 0, 0, 1, 1)
...
"font: 43pt \"Segoe UI\";")
    ...
    def retranslateUi(self, ccsqueue_faculty):
        ...
        self.label_3.setText(_translate("ccsqueue_faculty", "Queue"))
        self.currentnum_display.setText(_translate("ccsqueue_faculty", "0"))
        self.label_4.setText(_translate("ccsqueue_faculty", "NOW SERVING"))
        self.nextinline_slot1.setText(_translate("ccsqueue_faculty", "0"))
        self.nextinline_slot2.setText(_translate("ccsqueue_faculty", "0"))
        self.nextinline_slot3.setText(_translate("ccsqueue_faculty", "0"))
        self.label_10.setText(_translate("ccsqueue_faculty", "NEXT IN LINE"))
        self.label.setText(_translate("ccsqueue_faculty", "        GET QUEUE NUMBER"))
        self.label_2.setText(_translate("ccsqueue_faculty", "           SELECT PURPOSE HERE:"))
        self.enrollmentqueue_btn.setText(_translate("ccsqueue_faculty", "Enrollment"))
        self.clearancequeue_btn.setText(_translate("ccsqueue_faculty", "Clearance"))
        self.academicsqueue_btn.setText(_translate("ccsqueue_faculty", "Academics"))
        self.organizationqueue_btn.setText(_translate("ccsqueue_faculty", "Organization"))
        self.regularlane_btn.setText(_translate("ccsqueue_faculty", "Regular Lane"))
        self.facultylane_btn.setText(_translate("ccsqueue_faculty", "Faculty Lane"))
        ...
        item.setText(_translate("ccsqueue_faculty", "Reason"))
        self.tp_setRsv_btn.setText(_translate("ccsqueue_faculty", "Set"))
        item = self.pendingRsv_table.horizontalHeaderItem(0)
        item.setText(_translate("ccsqueue_faculty", "Date of Request"))
        ...
        item.setText(_translate("ccsqueue_faculty", "Description"))
        self.setQuest_btn.setText(_translate("ccsqueue_faculty", "Set"))
